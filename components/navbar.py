...
def show_navbar():
    ...
    with ui.element('div').classes('w-full flex flex-row justify-between items-center px-20 py-5 fixed top-0 left-0 z-50 bg-white text-sm').style('font-family: "Raleway", serif;'):
        with ui.row():
